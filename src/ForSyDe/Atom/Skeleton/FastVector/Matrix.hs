module ForSyDe.Atom.Skeleton.FastVector.Matrix where

import qualified GHC.List as L (take, drop)
import Prelude hiding (take, drop)
import qualified Data.List as L
import ForSyDe.Atom.Skeleton.FastVector (Vector(..), vector, fromVector, (<++>))
import qualified ForSyDe.Atom.Skeleton.FastVector as V
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.isNull'.
isNull :: Matrix a -> Bool
isNull (Vector []) = True
isNull (Vector [Vector []]) = True
isNull _ = False

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.size'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.wellFormed'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.Matrix'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.fromMatrix'.
fromMatrix :: Matrix a -- ^ /size/ = @(x,y)@
           -> [a]      -- ^ /length/ = @x * y@
fromMatrix = concatMap fromVector . fromVector

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.fanout'.
fanout :: a -> Matrix a
fanout n = V.fanout $ V.fanout n

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.indexes'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.farm11'.
farm11 :: (a -> b)
       -> Matrix a -- ^ /size/ = @(xa,ya)@
       -> Matrix b -- ^ /size/ = @(xa,ya)@
farm11 = V.farm11 . V.farm11

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.farm21'.
farm21 :: (a -> b -> c)
           -> Matrix a -- ^ /size/ = @(xa,ya)@
           -> Matrix b -- ^ /size/ = @(xb,yb)@
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.farm31'.
farm31 :: (a -> b -> c -> d)
            -> Matrix a -- ^ /size/ = @(xa,ya)@
            -> Matrix b -- ^ /size/ = @(xb,yb)@
            -> Matrix c -- ^ /size/ = @(xc,yc)@
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.reduce'.
reduce :: (a -> a -> a) -> Matrix a -> a
reduce f = V.reduce f . V.farm11 (V.reduce f)

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.fotV'.
dotV :: (a -> a -> a)
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.dot'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.get'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.take'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.drop'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.crop'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.group'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.stencil'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.reverse'.
reverse :: Matrix a -> Matrix a
reverse = V.reverse . V.farm11 V.reverse

-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.transpose'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Matrix.replace'.
