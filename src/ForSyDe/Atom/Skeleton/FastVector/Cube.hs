module ForSyDe.Atom.Skeleton.FastVector.Cube where

import ForSyDe.Atom.Skeleton.FastVector (Vector(..), vector, fromVector, (<++>))
import ForSyDe.Atom.Skeleton.FastVector.Matrix (Matrix, matrix, fromMatrix)

import qualified ForSyDe.Atom.Skeleton.FastVector as V
import qualified ForSyDe.Atom.Skeleton.FastVector.Matrix as M
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.isNull'.
isNull :: Matrix a -> Bool
isNull (Vector []) = True
isNull (Vector [Vector []]) = True
isNull _ = False

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.size'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.wellFormed'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.cube'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.fromCube'.
fromCube :: Cube a -- ^ /size/ = @(x,y)@
         -> [a]    -- ^ /length/ = @x * y@
fromCube = concatMap fromVector . fromMatrix

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.unit'.
unit :: a -> Cube a -- ^ /size/ = @(1,1)@
unit a = Vector [Vector [Vector [a]]]

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.fanout'.
fanout :: a -> Cube a
fanout n = V.fanout $ V.fanout $ V.fanout n

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.indexes'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.transpose'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.farm11'.
farm11 :: (a -> b)
       -> Cube a -- ^ /size/ = @(xa,ya)@
       -> Cube b -- ^ /size/ = @(xa,ya)@
farm11 = V.farm11 . V.farm11 . V.farm11

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.farm21'.
farm21 :: (a -> b -> c)
           -> Cube a -- ^ /size/ = @(xa,ya)@
           -> Cube b -- ^ /size/ = @(xb,yb)@
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.farm31'.
farm31 :: (a -> b -> c -> d)
            -> Cube a -- ^ /size/ = @(xa,ya)@
            -> Cube b -- ^ /size/ = @(xb,yb)@
            -> Cube c -- ^ /size/ = @(xc,yc)@
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.reduce'.
reduce :: (a -> a -> a) -> Cube a -> a
reduce f = V.reduce f . V.farm11 (M.reduce f)

-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.get'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.take'.
...
-- | See 'ForSyDe.Atom.Skeleton.Vector.Cube.drop'.
