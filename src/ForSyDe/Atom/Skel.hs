...
farm82 p v1 v2 v3 v4 v5 v6 v7 v8 = (p =.= v1 =*= v2 =*= v3 =*= v4 =*= v5 =*= v6 =*= v7 =*= v8 |<)
farm13 p v1                      = (p =.= v1 |<<)
...
farm63 :: Skeleton f => (a1 -> a2 -> a3 -> a4 -> a5 -> a6 -> (a7, b1, b2)) -> f a1 -> f a2 -> f a3 -> f a4 -> f a5 -> f a6 -> (f a7, f b1, f b2)
farm63 p v1 v2 v3 v4 v5 v6       = (p =.= v1 =*= v2 =*= v3 =*= v4 =*= v5 =*= v6 |<<)
farm73 p v1 v2 v3 v4 v5 v6 v7    = (p =.= v1 =*= v2 =*= v3 =*= v4 =*= v5 =*= v6 =*= v7 |<<)
farm83 p v1 v2 v3 v4 v5 v6 v7 v8 = (p =.= v1 =*= v2 =*= v3 =*= v4 =*= v5 =*= v6 =*= v7 =*= v8 |<<)
farm14 p v1                      = (p =.= v1 |<<<)
