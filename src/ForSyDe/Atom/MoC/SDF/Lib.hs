...
comb11 f s1          = MoC.comb11 (psi11 f) s1
comb21 f s1 s2       = MoC.comb21 (psi21 f) s1 s2
comb31 f s1 s2 s3    = MoC.comb31 (psi31 f) s1 s2 s3
comb41 f s1 s2 s3 s4 = MoC.comb41 (psi41 f) s1 s2 s3 s4
comb12 f s1          = MoC.comb12 (psi12 f) s1
comb22 f s1 s2       = MoC.comb22 (psi22 f) s1 s2
comb32 f s1 s2 s3    = MoC.comb32 (psi32 f) s1 s2 s3
comb42 f s1 s2 s3 s4 = MoC.comb42 (psi42 f) s1 s2 s3 s4
comb13 f s1          = MoC.comb13 (psi13 f) s1
comb23 f s1 s2       = MoC.comb23 (psi23 f) s1 s2
comb33 f s1 s2 s3    = MoC.comb33 (psi33 f) s1 s2 s3
comb43 f s1 s2 s3 s4 = MoC.comb43 (psi43 f) s1 s2 s3 s4
comb14 f s1          = MoC.comb14 (psi14 f) s1
comb24 f s1 s2       = MoC.comb24 (psi24 f) s1 s2
comb34 f s1 s2 s3    = MoC.comb34 (psi34 f) s1 s2 s3
comb44 f s1 s2 s3 s4 = MoC.comb44 (psi44 f) s1 s2 s3 s4
...
constant1 i = MoC.scanld01 (psi11 vid1) (event  i)
constant2 i = MoC.scanld02 (psi22 vid2) (event2 i)
constant3 i = MoC.scanld03 (psi33 vid3) (event3 i)
constant4 i = MoC.scanld04 (psi44 vid4) (event4 i)
