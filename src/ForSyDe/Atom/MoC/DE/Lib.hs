...
stated11 :: (b1 -> a1 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig b1                                
stated12 :: (b1 -> b2 -> a1 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> (Sig b1, Sig b2)                          
stated13 :: (b1 -> b2 -> b3 -> a1 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3)                      
stated14 :: (b1 -> b2 -> b3 -> b4 -> a1 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3, Sig b4)                  
stated21 :: (b1 -> a1 -> a2 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig b1                          
stated22 :: (b1 -> b2 -> a1 -> a2 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2)                    
stated23 :: (b1 -> b2 -> b3 -> a1 -> a2 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3)                
stated24 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3, Sig b4)                     
stated31 :: (b1 -> a1 -> a2 -> a3 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig b1                    
stated32 :: (b1 -> b2 -> a1 -> a2 -> a3 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2)              
stated33 :: (b1 -> b2 -> b3 -> a1 -> a2 -> a3 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3)          
stated34 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> a3 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3, Sig b4)     
stated41 :: (b1 -> a1 -> a2 -> a3 -> a4 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> Sig b1              
stated42 :: (b1 -> b2 -> a1 -> a2 -> a3 -> a4 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2)        
stated43 :: (b1 -> b2 -> b3 -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3)    
stated44 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3, Sig b4)
...
state11 :: (b1 -> a1 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig b1                                
state12 :: (b1 -> b2 -> a1 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> (Sig b1, Sig b2)                          
state13 :: (b1 -> b2 -> b3 -> a1 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3)                      
state14 :: (b1 -> b2 -> b3 -> b4 -> a1 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3, Sig b4)                  
state21 :: (b1 -> a1 -> a2 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig b1                          
state22 :: (b1 -> b2 -> a1 -> a2 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2)                    
state23 :: (b1 -> b2 -> b3 -> a1 -> a2 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3)                
state24 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3, Sig b4)                     
state31 :: (b1 -> a1 -> a2 -> a3 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig b1                    
state32 :: (b1 -> b2 -> a1 -> a2 -> a3 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2)              
state33 :: (b1 -> b2 -> b3 -> a1 -> a2 -> a3 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3)          
state34 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> a3 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3, Sig b4)     
state41 :: (b1 -> a1 -> a2 -> a3 -> a4 -> b1) -> (Int, b1)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> Sig b1              
state42 :: (b1 -> b2 -> a1 -> a2 -> a3 -> a4 -> (b1, b2)) -> ((Int, b1), (Int, b2))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2)        
state43 :: (b1 -> b2 -> b3 -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3)) -> ((Int, b1), (Int, b2), (Int, b3))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3)    
state44 :: (b1 -> b2 -> b3 -> b4 -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3, b4)) -> ((Int, b1), (Int, b2), (Int, b3), (Int, b4))
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3, Sig b4)
