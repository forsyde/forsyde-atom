...
-- >>> toSY2 s1 s2
-- ({0.0,2.0,6.0,8.0,9.0},{1,1,1,1,1},{1,2,3,4,5})
--
-- <<fig/moc-de-tosy.png>>
...
-- >>> v1
-- <{1@0.0,2@2.0,3@6.0,4@8.0,5@9.0},{1@0.0,2@2.0,3@6.0,4@8.0,5@9.0},{1@0.0,2@2.0,3@4.0,4@8.0,5@9.0},{1@0.0,2@2.0,3@4.0,4@8.0,5@9.0}>
-- >>> zipx v1
-- {<1,1,1,1>@0.0,<2,2,2,2>@2.0,<2,2,3,3>@4.0,<3,3,3,3>@6.0,<4,4,4,4>@8.0,<5,5,5,5>@9.0}
--
-- <<fig/moc-de-zipx.png>>
...
-- >>> s1
-- {<1,2,3,4>@0.0,<1,2,3,4>@2.0,<1,2,3,4>@6.0,<1,2,3,4>@8.0,<1,2,3,4>@9.0}
-- >>> unzipx 4 s1
-- <{1@0.0,1@2.0,1@6.0,1@8.0,1@9.0},{2@0.0,2@2.0,2@6.0,2@8.0,2@9.0},{3@0.0,3@2.0,3@6.0,3@8.0,3@9.0},{4@0.0,4@2.0,4@6.0,4@8.0,4@9.0}>
--
