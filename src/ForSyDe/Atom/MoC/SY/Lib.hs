...
constant1 i = MoC.scanld01 ((psi11 . psi11) id1) (event  i)
constant2 i = MoC.scanld02 ((psi22 . psi22) id2) (event2 i)
constant3 i = MoC.scanld03 ((psi33 . psi33) id3) (event3 i)
constant4 i = MoC.scanld04 ((psi44 . psi44) id4) (event4 i)
...
generate1 ns i = MoC.scanld01 ((psi11 . psi11) ns) (event  i)
generate2 ns i = MoC.scanld02 ((psi22 . psi22) ns) (event2 i)
generate3 ns i = MoC.scanld03 ((psi33 . psi33) ns) (event3 i)
generate4 ns i = MoC.scanld04 ((psi44 . psi44) ns) (event4 i)
...
buffer1 i = MoC.scanl11 (psi21 store1) (event i)
buffer2 i = MoC.scanl21 (psi31 store2) (event i)
buffer3 i = MoC.scanl31 (psi41 store3) (event i)
buffer4 i = MoC.scanl41 (psi51 store4) (event i)
