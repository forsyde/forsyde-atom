...
constant1 i = MoC.scanld01 (psi11 id1) (argument  i)
constant2 i = MoC.scanld02 (psi22 id2) (argument2 i)
constant3 i = MoC.scanld03 (psi33 id3) (argument3 i)
constant4 i = MoC.scanld04 (psi44 id4) (argument4 i)
...
generate1 ns i = MoC.scanld01 (psi11 ns) (argument  i)
generate2 ns i = MoC.scanld02 (psi22 ns) (argument2 i)
generate3 ns i = MoC.scanld03 (psi33 ns) (argument3 i)
generate4 ns i = MoC.scanld04 (psi44 ns) (argument4 i)
...
-- buffer1 i = MoC.scanl11 store1 (argument i)
-- buffer2 i = MoC.scanl21 store2 (argument i)
-- buffer3 i = MoC.scanl31 store3 (argument i)
-- buffer4 i = MoC.scanl41 store4 (argument i)


-- -- FILTER, FILL, HOLD

-- -- | This process predicates the existence of arguments in a signal based
...
-- -- | Fills absent arguments with a pre-defined value. 
-- --
...
-- -- {1,2,3,3,3,3}
-- hold :: a -> Sig a -> Sig a
-- hold init = MoC.scanl11 fillF (argument init)
