...
comb11 f s1          =        (f -§ s1)
comb12 f s1          = funzip2 (f -§ s1)
comb13 f s1          = funzip3 (f -§ s1)
comb14 f s1          = funzip4 (f -§ s1)
comb21 f s1 s2       =        (f -§ s1 §§ s2)
comb22 f s1 s2       = funzip2 (f -§ s1 §§ s2)
comb23 f s1 s2       = funzip3 (f -§ s1 §§ s2)
comb24 f s1 s2       = funzip4 (f -§ s1 §§ s2)
comb31 f s1 s2 s3    =        (f -§ s1 §§ s2 §§ s3)
comb32 f s1 s2 s3    = funzip2 (f -§ s1 §§ s2 §§ s3)
comb33 f s1 s2 s3    = funzip3 (f -§ s1 §§ s2 §§ s3)
comb34 f s1 s2 s3    = funzip4 (f -§ s1 §§ s2 §§ s3)
comb41 f s1 s2 s3 s4 =        (f -§ s1 §§ s2 §§ s3 §§ s4)
comb42 f s1 s2 s3 s4 = funzip2 (f -§ s1 §§ s2 §§ s3 §§ s4)
comb43 f s1 s2 s3 s4 = funzip3 (f -§ s1 §§ s2 §§ s3 §§ s4)
comb44 f s1 s2 s3 s4 = funzip4 (f -§ s1 §§ s2 §§ s3 §§ s4)
