...
\begin{tikzpicture}
  ...
  \begin{signalsDE}[grid,timestamps=5,inputs={p1}, num signals=2]{11}
    \signalDE{1:0}
...
\begin{tikzpicture}
  ...
  \begin{signalsDE}[grid,timestamps=5,inputs={p1}, num signals=2]{11}
    ...
    \signalDE{ 1:0, 2:2, 3:6, 4:8, 5:9}
  \end{signalsDE}
  \begin{signalsDE}[grid,timestamps=5,outputs={p1}, num signals=2]{11}
    \signalDE{ 2 :0, 3 :2, 4 :6, 5 :8, 6 :9}
...
\begin{tikzpicture}
  ...
  \begin{signalsDE}[grid,timestamps=5,inputs={p1}, num signals=2]{13}
    \signalDE{1:0, 2:2, 3:6, 4:8, 5:9}
...
\begin{tikzpicture}
  ...
  \begin{signalsDE}[grid,timestamps=5,outputs={p1}, num signals=2]{7}
...
\begin{tikzpicture}
  ...
  \begin{signalsDE}[grid,timestamps=5,inputs={p1}, num signals=2]{15}
    \signalDE{1:0, 2:2, 3:6, 4:8,  5:9}
    \signalDE{1:0, 2:5, 3:6, 4:10, 5:12}
  \end{signalsDE}
  \begin{signalsDE}[grid,timestamps=5,outputs={p1}, num signals=2]{15}
